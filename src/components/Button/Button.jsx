...
const COLORS = {
  ...
  dark: "border-dark-700 text-dark-1800",
};
const VARIANTS = {
  ...
  primaryContained:
    " bg-primary text-white text-base font-bold hover:bg-primary-200",
  darkContained: " bg-dark-700 text-white hover:bg-dark-700/80",
  darkOutlined:
    " bg-white text-dark-700 hover:text-white hover:bg-dark-700 border border-dark-700 w-40 flex justify-center",
  tag: "border",
  ...
  text: "border-0",
  transparent:
    " hover:text-white hover:bg-dark-700 border  w-40 flex justify-center",
};
const SIZES = {
  xs: "h-5 p-2",

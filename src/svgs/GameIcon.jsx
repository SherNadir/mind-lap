  ...
  return (
    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        {" "}
        <g id="smart_lamp" /> <g id="e-wallet" /> <g id="virtual_reality" />{" "}
        <g id="payment" /> <g id="cloud_storage" /> <g id="security_camera" />{" "}
        <g id="smart_home" /> <g id="connection" />{" "}
        <g id="game">
          {" "}
          <g>
            {" "}
        ...
        <g id="drone" /> <g id="smart_car" /> <g id="camera" />{" "}
        <g id="online_business" /> <g id="smartwatch" />{" "}
        <g id="online_shopping" /> <g id="smart_Television" />{" "}
        <g id="security" /> <g id="communication" /> <g id="remote_control" />{" "}
        <g id="satelite_dish" />{" "}
      </g>
    </svg>
  );

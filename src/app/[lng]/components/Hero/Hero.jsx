  ...
  return (
    <div className="content w-4/5  m-auto mb-[100px]">
      <div className="w-full flex flex-col text-center lg:text-start lg:w-3/5 ">
        <p className={`text-sm sm:text-4xl text-dark mt-10 `}>{t("FUTURE")}</p>
        <p className="mt-[44px] text-6xl sm:text-7xl text-primary">MINDELAP</p>
      ...
      <div className="flex px-3 sm:px-8 py-3 bg-white rounded-full gap-0 sm:gap-4 max-w-[40rem] justify-between border border-grey-light mt-[80px]">
        <div>
